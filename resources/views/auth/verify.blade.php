...
<body>
    ...
    <div class="form-wrapper">
        ...
        <p class="subtext">We’ve sent a 6-digit verification code to <strong>{{ $email }}</strong>.<br>Enter it below to
        ...
        <form method="POST" action="{{ route('verify') }}">
            ...
            <input type="text" name="verification_code" placeholder="Enter 6-digit code" required><br>
